...
For the Karst, PyroWISE uses Karst-specific fuel parameterisations rather than the generic Anderson (1982) or Scott & Burgan (2005) fuel models. The mapping from observed vegetation to fuel parameters is part of the commercial calibration.
